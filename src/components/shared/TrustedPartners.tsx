	...
	return (
		<section className="py-16 md:py-24">
			<div className="page-wrap">
				{/* Header row */}
				<div className="motion-scroll-reveal flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-10 md:mb-14">
				...
				{/* Grid */}
				<div className="motion-scroll-reveal motion-stagger grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-4 md:gap-6">
					{PARTNERS.map((client) => (
