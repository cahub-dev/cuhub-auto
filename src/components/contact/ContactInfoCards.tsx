...
const CONTACT_CARDS = [
	...
	},
	{
		title: "Phone Number",
		icon: Phone,
		lines: ["+258 862499172", "+258 848880551", "Mr. Vasco, Manager"],
	},
] as const;
	...
	return (
		<section className="py-16 md:py-24">
			<div className="page-wrap">
				<div className="motion-scroll-reveal mb-14 text-center">
				...
				<div className="motion-scroll-reveal motion-stagger grid gap-6 md:grid-cols-3">
					{CONTACT_CARDS.map((card) => {
						...
						return (
							<div
								key={card.title}
								className="motion-card relative rounded-2xl bg-white px-6 pb-8 pt-16 text-center shadow-[0_10px_28px_rgba(0,0,0,0.05)]"
							>
